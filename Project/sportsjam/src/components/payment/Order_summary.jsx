  ...
  return (
    ...
    <div style={{"display":"flex","gap":"30px"}}>
        <div>
            ...
            <div style={{"width":"821px","height":"121px"}}>
                <b>Use your voucher code</b>
                <p>Only one coupon code can be used per order at this time.</p>
                <b>Voucher code<input style={{"backgroundColor":"black","borderRadius":"5px"}}/> <button style={{"width":"54px","height":"26px","margin":"30px"}}>Apply</button></b>
            </div>
        </div>
